...
match(_event, add_object_rel_et(Obj)) :- deep_subdict(_event, _{intent:_{name:"add_relative_object", confidence:_}, entities:_{object:_, horizontal:_, vertical:_, relative:_, relName:Obj}}).
match(_event, remove_object_et(Obj)) :- deep_subdict(_event, _{intent:_{name:"remove_object", confidence:_}, entities:_{object:_, horizontal:_, vertical:_, relative:_, relName:Obj}}).
